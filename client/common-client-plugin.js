function register ({ registerHook, peertubeHelpers }) {
  registerHook({
    ...
    handler: async ({ path }) => {
      ...
      if (document.querySelector('.custom-link-1') === null && c.link_1_text && c.link_1_url) {
      ...
      if (document.querySelector('.custom-link-2') === null && c.link_2_text && c.link_2_url) {
        newLink = document.createElement('a');
      ...
      if (document.querySelector('.custom-link-3') === null && c.link_3_text && c.link_3_url) {
        newLink = document.createElement('a');
      ...
      if (document.querySelector('.custom-link-4') === null && c.link_4_text && c.link_4_url) {
        newLink = document.createElement('a');
      ...
      if (document.querySelector('.custom-link-5') === null && c.link_5_text && c.link_5_url) {
        newLink = document.createElement('a');
